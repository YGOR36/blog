		...
		<div class="sh-filter">
			...
			<?php foreach( $categories_tabs as $category_id ) :
				...
				<span class="sh-filter-item<?php echo ( $this_category == $category->slug ) ? ' active' : ''; ?>">
					...
					<?php if ( $category->slug =='ferramentas'){?>
					<i class="fas fa-cog"></i>
					<?php }?>
					<?php if ( $category->slug =='e-books'){?>
					<i class="fas fa-book"></i>
					<?php }?>
					<?php if ( $category->slug =='webinar'){?>
					<i class="far fa-play-circle"></i>
					<?php }?>
					<?php if ( $category->slug =='infograficos'){?>
			...
			<span id="materiais" >
<a href="#" class="sh-filter-item-content">	
Materiais Gratuitos
